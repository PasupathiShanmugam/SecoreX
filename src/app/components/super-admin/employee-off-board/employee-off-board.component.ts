...
@Component({
  selector: 'app-employee-off-board',
  templateUrl: './employee-off-board.component.html',
  styleUrls: ['./employee-off-board.component.css']
})
export class EmployeeOffBoardComponent implements OnInit {
