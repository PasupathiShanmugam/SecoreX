...
@Component({
  selector: 'app-master-profile-add',
  templateUrl: './master-profile-add.component.html',
  styleUrls: ['./master-profile-add.component.css']
})
export class MasterProfileAddComponent implements OnInit {
